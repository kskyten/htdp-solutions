...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex37) (read-case-sensitive #t) (teachpacks ((lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")))))
(require 2htdp/image)
...
(check-expect (end? (+ WIDTH-OF-WORLD CAR-WIDTH)) true)

(define (end? cw)
  (cond
   [(< cw (+ WIDTH-OF-WORLD HALF-CAR-WIDTH)) false]
   [(>= cw (+ WIDTH-OF-WORLD HALF-CAR-WIDTH)) true]))
