...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ex266) (read-case-sensitive #t) (teachpacks ((lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp")))))
(define-struct dir (name size readability content))
; A Dir.v2 is a structure:
;   (make-dir Symbol N Boolean LOFD)
