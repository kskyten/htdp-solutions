...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname ex127) (read-case-sensitive #t) (teachpacks ((lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")))))
; all-true?: List-of-Booleans -> Boolean
; Are all the values true in lst?
...
(define (all-true? lst)
  (cond
    [(empty? lst) true]
    [(cons? lst) (and (boolean=? true (first lst))
                      (all-true? (rest lst)))]))
...
(define (one-true? lst)
  (cond
    [(empty? lst) false]
    [(cons? lst) (or (boolean=? true (first lst))
                     (one-true? (rest lst)))]))